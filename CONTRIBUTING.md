...
2. **Clone** your fork: `git clone https://github.com/YOUR-USERNAME/infra-monitoring-dashboard.git`
...
git clone https://github.com/donny-devops/infra-monitoring-dashboard.git
